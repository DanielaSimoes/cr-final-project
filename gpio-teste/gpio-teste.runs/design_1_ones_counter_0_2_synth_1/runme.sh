...
HD_PWD='C:/Users/darny/gpio-teste/gpio-teste.runs/design_1_ones_counter_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ones_counter_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ones_counter_0_2.tcl
